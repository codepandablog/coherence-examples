...
public class RunEmployeeExample {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Employee " + emp.getFirstName() + " " + emp.getLastName() + ", salary = $" + emp.getSalary()); // give
																															// them
																															// a
																															// 10%
																															// pay
		...
		System.out.println("New Employee details are " + emp2.getFirstName() + " " + emp2.getLastName() + ", salary = $"
				+ emp2.getSalary());
